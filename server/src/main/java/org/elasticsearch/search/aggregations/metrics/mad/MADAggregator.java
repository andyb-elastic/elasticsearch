...
public class MADAggregator extends NumericMetricsAggregator.SingleValue {
    ...
    /*
     * todo what's the right thing to do here? we can't really compute the metric yet because we can only do it after the reduce phase.
     * do we make a best effort here or just return nan?
     * it looks like this is only used in one place and it's specifically for the terms aggregation
     */
    @Override
